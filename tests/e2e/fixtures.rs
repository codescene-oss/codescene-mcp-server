//! Test fixtures providing sample code for e2e tests.
//!
...
pub const GOOD_PYTHON_CODE: &str = r#""""
...
pub const COMPLEX_PYTHON_CODE: &str = r#""""
...
/// Complex JavaScript code with code smells.
pub const COMPLEX_JAVASCRIPT_CODE: &str = r#"/**
...
/// Java code sample.
pub const JAVA_CODE: &str = r#"package com.example.service;
...
/// Get a map of sample files for testing.
pub fn get_sample_files() -> HashMap<&'static str, &'static str> {
    let mut files = HashMap::new();
    files.insert("src/utils/calculator.py", GOOD_PYTHON_CODE);
...
pub fn get_expected_scores() -> HashMap<&'static str, (f64, f64)> {
    let mut scores = HashMap::new();
    scores.insert("src/utils/calculator.py", (8.5, 10.0));
    scores.insert("src/services/order_processor.py", (7.0, 9.0));
    scores.insert("src/auth/AuthService.js", (7.0, 10.0));
    scores.insert("src/services/order_processor.js", (5.0, 9.0));
    scores.insert("src/main/java/com/example/OrderProcessor.java", (9.0, 10.0));
    scores
}
