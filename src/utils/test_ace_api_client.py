...
from .ace_api_client import post_refactor, get_api_endpoint, HttpClientError
...
class TestPostRefactor(unittest.TestCase):
    ...
    @mock.patch('requests.post', side_effect=mock_requests("api/refactor", 403, {"error": "some-error"}))
